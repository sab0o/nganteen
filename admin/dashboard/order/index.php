        ...
        <div class="row">
            ...
            <main class="col-md-8 ms-sm-auto col-lg-10 px-md-4 py-4">
                ...
                <div class="row justify-content-between my-4">
                    <div class="col-md-3">
                        <a href="download.php" target="_blank" class="btn btn-primary">Download</a>
                    </div>
                    <div class="col-md-3">
                    ...
                    <tbody>
                        ...
                        <?php foreach($checkouts as $checkout) : ?>
                            <tr>
                                ...
                                <td><?= $checkout['pName']; ?></td> 
                                <td><?= $checkout['amount']; ?></td>
                                <td><?= $checkout['status']; ?></td>
                                
                                <td>
                                    <a href="info.php?id=<?= $checkout['id']; ?>" class="btn btn-info">Detail</a>
                                    <a href="update.php?id=<?= $checkout['id']; ?>" class="btn btn-warning">Update</a>
                                    <a href="delete.php?id=<?= $checkout['id']; ?>" class="btn btn-danger">Delete</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
